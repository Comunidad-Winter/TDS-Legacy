...
<head>    
    ...
    <title>TDS Legacy - Agregar personaje</title>
...
<b id="response" style="color:008000;margin:10px;"></b>
    ...
    <div name="form1" id="cuentasPremium">
        <fieldset>
            <div class="campos">
            <p class="form-tit">Completá este formulario para agregar un personaje</p>
            <label for="nick">*Nick de tu personaje</label>
            <span class="input"><input name="nick" type="text" id="nick" size="10" maxlength="30" autocomplete="off" required value=""></span>
            <label for="pass">*Contraseña del personaje</label>
            <span class="input"><input name="pass" type="password" id="pass" size="10" maxlength="30" autocomplete="off" required value=""></span>
            <label for="pni">*Pin del personaje</label>
            <span class="input"><input name="pin" type="password" id="pin" size="10" maxlength="30" autocomplete="off" required value=""></span>
            <div class="clear"></div>
            </div>
            <div class="clear"></div>
            <a id="Submit"  href="#" onclick="return agregarpj()">Agregar PJ</a><br>
        </fieldset>
    </div>
</div>
</div>
