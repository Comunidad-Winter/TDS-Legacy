...
if (!isset($_GET['nick'])) {
    exit('<b>El personaje no esta habilitado para mostrar estas estadisticas.</b>');
}
if (empty($_GET['nick'])) {
    exit('<b>El personaje no esta habilitado para mostrar estas estadisticas.</b>');
}
    ...
    if (!mysqli_stmt_prepare($stmt, $sql)) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if ($rowINIT['ban'] == 1 || $rowINIT['mao_index'] == 0 ) {
                exit('<b>El personaje '.$nick.' no esta habilitado para mostrar estas estadisticas.</b>');
            }
        ...
        }else exit('<b>El personaje '.$nick .' no esta habilitado para mostrar estas estadisticas.</b>');
    }?>
</div>
</div>
</div>
