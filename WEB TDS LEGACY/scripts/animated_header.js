(function (cjs, an) {
    ...
    (lib.image3_1 = function () {
      this.initialize(img.image3_1);
    }).prototype = p = new cjs.Bitmap();
    ...
    (lib.image8_1 = function () {
      this.initialize(img.image8_1);
    }).prototype = p = new cjs.Bitmap();
    ...
    (lib.shape15 = function (mode, startPosition, loop) {
      ...
      this.shape.graphics
        .bf(img.image14, null, new cjs.Matrix2D(1, 0, 0, 1, -31, -49.5))
        .s()
        .p("Ak1HvIAAvdIJrAAIAAPdg");
    ...
    (lib.shape13 = function (mode, startPosition, loop) {
      ...
      this.shape = new cjs.Shape();
      this.shape.graphics
        .bf(img.image12, null, new cjs.Matrix2D(1, 0, 0, 1, -139.5, -47))
        .s()
        .p("A1yHWIAAurMArlAAAIAAOrg");
      this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));
    }).prototype = p = new cjs.MovieClip();
    ...
    (lib.shape11 = function (mode, startPosition, loop) {
      ...
      this.shape = new cjs.Shape();
      this.shape.graphics
        .bf(img.image10, null, new cjs.Matrix2D(1, 0, 0, 1, -326.5, -55.5))
        .s()
        .p("EgzAAIrIAAxVMBmBAAAIAARVg");
      this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));
    }).prototype = p = new cjs.MovieClip();
    ...
    (lib.shape9 = function (mode, startPosition, loop) {
      ...
      this.shape = new cjs.Shape();
      this.shape.graphics
        .bf(img.image8_1, null, new cjs.Matrix2D(1, 0, 0, 1, -295, -31))
        .s()
        .p("EguFAE2IAAprMBcLAAAIAAJrg");
      this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));
    }).prototype = p = new cjs.MovieClip();
    ...
    (lib.shape4 = function (mode, startPosition, loop) {
      ...
      this.shape = new cjs.Shape();
      this.shape.graphics
        .bf(img.image3_1, null, new cjs.Matrix2D(1, 0, 0, 1, -350, -52))
        .s()
        .p("Eg2rAIIIAAwPMBtXAAAIAAQPg");
    ...
    (lib.shape2 = function (mode, startPosition, loop) {
      ...
      this.shape = new cjs.Shape();
      this.shape.graphics
        .bf(img.image1_1, null, new cjs.Matrix2D(1, 0, 0, 1, -350, -40))
        .s()
        .p("Eg2rAGQIAAsfMBtXAAAIAAMfg");
      this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));
    }).prototype = p = new cjs.MovieClip();
    ...
    (lib.shape10 = function (mode, startPosition, loop) {
      ...
      this.shape = new cjs.Shape();
      this.shape.graphics
        .bf(img.image9, null, new cjs.Matrix2D(1, 0, 0, 1, -31, -21))
        .s()
        .p("Ak1DSIAAmjIJrAAIAAGjg");
      this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));
    }).prototype = p = new cjs.MovieClip();
    ...
    (lib.shape6_1 = function (mode, startPosition, loop) {
      this.initialize(mode, startPosition, loop, {});
      this.shape_1 = new cjs.Shape();
      this.shape_1.graphics
        .bf(img.image5, null, new cjs.Matrix2D(1, 0, 0, 1, -56.5, -19.5))
        .s()
        .p("Ao0DDIAAmFIRpAAIAAGFg");
      this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));
    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = new cjs.Rectangle(-56.5, -19.5, 113, 39);
    (lib.shape4_1 = function (mode, startPosition, loop) {
      this.initialize(mode, startPosition, loop, {});
      this.shape_1 = new cjs.Shape();
      this.shape_1.graphics
        .bf(img.image3, null, new cjs.Matrix2D(1, 0, 0, 1, -24.5, -29.5))
        .s()
        .p("Aj0EnIAApNIHpAAIAAJNg");
      this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));
    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = new cjs.Rectangle(-24.5, -29.5, 49, 59);
    (lib.shape2_1 = function (mode, startPosition, loop) {
      this.initialize(mode, startPosition, loop, {});
      this.shape_1 = new cjs.Shape();
      this.shape_1.graphics
        .bf(img.image1, null, new cjs.Matrix2D(1, 0, 0, 1, -295.5, -52))
        .s()
        .p("EguKAIIIAAwPMBcVAAAIAAQPg");
      this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));
    }).prototype = p = new cjs.MovieClip();
    p.nominalBounds = new cjs.Rectangle(-295.5, -52, 591, 104);
    (lib.shape9_1 = function (mode, startPosition, loop) {
      this.initialize(mode, startPosition, loop, {});
      this.shape_1 = new cjs.Shape();
      this.shape_1.graphics
        .bf(img.image8, null, new cjs.Matrix2D(1, 0, 0, 1, -34, -12))
        .s()
        .p("AlTB4IAAjvIKnAAIAADvg");
      this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1));
    }).prototype = p = new cjs.MovieClip();
    ...
    (lib.shape7 = function (mode, startPosition, loop) {
      ...
      this.shape = new cjs.Shape();
      this.shape.graphics
        .bf(img.image6, null, new cjs.Matrix2D(1, 0, 0, 1, -25, -14))
        .s()
        .p("Aj5CMIAAkXIHzAAIAAEXg");
      this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));
    }).prototype = p = new cjs.MovieClip();
    ...
    (lib.shape5 = function (mode, startPosition, loop) {
      ...
      this.shape = new cjs.Shape();
      this.shape.graphics
        .bf(img.image4, null, new cjs.Matrix2D(1, 0, 0, 1, -50.5, -14.5))
        .s()
        .p("An4CRIAAkhIPxAAIAAEhg");
      this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));
    }).prototype = p = new cjs.MovieClip();
    ...
    (lib.shape3 = function (mode, startPosition, loop) {
      ...
      this.shape = new cjs.Shape();
      this.shape.graphics
        .bf(img.image2, null, new cjs.Matrix2D(1, 0, 0, 1, -38, -37.5))
        .s()
        .p("Al7F3IAArtIL3AAIAALtg");
    ...
    (lib.sprite11 = function (mode, startPosition, loop) {
      ...
      this.frame_771 = function () {
        this.gotoAndPlay(321);
      };
      this.timeline.addTween(
        cjs.Tween.get(this).wait(771).call(this.frame_771).wait(1),
      );
      ...
      this.timeline.addTween(
        cjs.Tween.get(this.instance_1)
          .wait(88)
          .to({ _off: false }, 0)
          .to({ x: 247.5, alpha: 0.602 }, 9)
          .to({ x: 67.8, alpha: 0.672 }, 224)
          .to({ x: -293.2, alpha: 0.809 }, 450)
          .wait(1),
      );
      ...
      this.timeline.addTween(
        cjs.Tween.get(this.instance_4)
          .wait(189)
          .to({ _off: false }, 0)
          .to({ x: 238.6, alpha: 0.969 }, 132)
          .to({ x: -265.5, alpha: 0.859 }, 450)
          .wait(1),
      );
      ...
      this.timeline.addTween(
        cjs.Tween.get(this.instance_7)
          .wait(82)
          .to({ _off: false }, 0)
          .to({ x: 61.6, alpha: 1 }, 15)
          .to({ x: -75.6, alpha: 0.922 }, 224)
          .to({ x: -351.2, alpha: 0.75 }, 450)
          .wait(1),
      );
    ...
    (lib.sprite16 = function (mode, startPosition, loop) {
      ...
      this.timeline.addTween(
        cjs.Tween.get(this).wait(27).call(this.frame_27).wait(1),
      );
      ...
      this.timeline.addTween(
        cjs.Tween.get(this.instance_1)
          ...
          .to({ y: -10 }, 0)
          .wait(1)
          .to({ rotation: -0.5, x: -77.6, y: -8.3 }, 0)
          .wait(1)
          .to({ rotation: -1.2, x: -77.2, y: -6.6 }, 0)
          .wait(11),
      );
    ...
    (lib.sprite10 = function (mode, startPosition, loop) {
      ...
      this.frame_1506 = function () {
        this.gotoAndPlay(988);
      };
      this.timeline.addTween(
        cjs.Tween.get(this).wait(1506).call(this.frame_1506).wait(2),
      );
      ...
      this.timeline.addTween(
        cjs.Tween.get(this.instance_5)
          .wait(948)
          .to({ _off: false }, 0)
          .to({ scaleX: 1.47, scaleY: 0.75, x: 264, y: -30.1 }, 13)
          .to({ scaleX: 1, scaleY: 1, rotation: 0, x: -82.2, y: 0.5 }, 545)
          .wait(2),
      );
    ...
    (lib.sprite12 = function (mode, startPosition, loop) {
      ...
      this.timeline.addTween(
        cjs.Tween.get(this.noche_movimiento)
          .wait(1)
          .to({ alpha: 0.02 }, 4)
          .wait(1)
          .to({ alpha: 0.051 }, 3)
    ...
    (lib.sprite11_1 = function (mode, startPosition, loop) {
      ...
      this.initialize(mode, startPosition, loop, {});
      this.frame_0 = function () {
        this.dia_movimiento.gotoAndPlay(2);
      };
      ...
      this.timeline.addTween(
        cjs.Tween.get(this.dia_movimiento)
          .to({ alpha: 0.988 }, 53)
          .wait(1)
          .to({ alpha: 1 }, 0)
          .wait(6),
    ...
    (lib.sprite7 = function (mode, startPosition, loop) {
      ...
      this.timeline.addTween(
        cjs.Tween.get({})
          .to({ state: [] })
          .to({ state: [{ t: this.dia }] }, 1)
          .to({ state: [{ t: this.noche }] }, 1)
          .wait(1),
      );
    ...
    (lib.animated_header = function (mode, startPosition, loop) {
      ...
      this.frame_0 = function () {
        ...
        this.day_night = function () {
          if (this.dia) {
            this.tg.gotoAndStop(1);
          } else {
            this.tg.gotoAndStop(2);
          }
        };
      };
      ...
      mask._off = true;
      mask.graphics.p(
        "EgmfAHtIigjIQgsgthYAXQhZAWgnApIAAsVMAisgAKQObAFZOgLQHfgDIIgmQAIA9ACAyQACAxgGAqQgHArAIBBIgHITQgZgxhggIQhhgIgtA0QgtAzgaCSg",
      );
    ...
    lib.properties = {
      id: "A1C62C307CCA81458AE949DB14BBDFD2",
      width: 700,
      height: 197,
      fps: 22,
      color: "#000000",
      opacity: 1.0,
      manifest: [
        { src: "/header_images/image1.png", id: "image1" },
        { src: "/header_images/image1_1.png", id: "image1_1" },
        { src: "/header_images/image10.png", id: "image10" },
        { src: "/header_images/image12.png", id: "image12" },
        { src: "/header_images/image14.png", id: "image14" },
        { src: "/header_images/image2.png", id: "image2" },
        { src: "/header_images/image3.png", id: "image3" },
        { src: "/header_images/image3_1.png", id: "image3_1" },
        { src: "/header_images/image4.png", id: "image4" },
        { src: "/header_images/image5.png", id: "image5" },
        { src: "/header_images/image6.png", id: "image6" },
        { src: "/header_images/image7.png", id: "image7" },
        { src: "/header_images/image8.png", id: "image8" },
        { src: "/header_images/image8_1.png", id: "image8_1" },
        { src: "/header_images/image9.png", id: "image9" },
      ],
      preloads: [],
    };
    ...
    an.compositions["A1C62C307CCA81458AE949DB14BBDFD2"] = {
      getStage: function () {
