...
Public Function Porcentaje2(ByVal Total As Long, ByVal Porc As Long) As Double
    ...
    Porcentaje2 = Total * Porc / 100

    If b Then
        Porcentaje2 = Porcentaje2 * 10
    End If

    Exit Function
Errhandler:
    Porcentaje2 = CLng((Total * ("0." & Porc) / 100))
End Function

Public Function Porcentaje(ByVal Total As Long, ByVal Porc As Long) As Double
    On Error GoTo Errhandler
    ...
    If Total > 10000000 Then
        factor = 10#
    End If
    Dim totalAjustado As Double
    totalAjustado = Total / factor
    Porcentaje = totalAjustado * Porc / 100#
    Exit Function
Errhandler:
    Porcentaje = CLng((Total * ("0." & Porc) / 100))
End Function
