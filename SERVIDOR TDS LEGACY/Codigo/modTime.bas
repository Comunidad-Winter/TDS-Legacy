...
Public Function GetTickCount() As Long
    ...
    Exit Function
GetTickCount_Err:
    Call LogError("ModLadder.GetTickCount en " & Erl & ". err: " & Err.Number & " " & Err.Description)
End Function
...
Function GetTimeFormated() As String
    ...
    Exit Function
GetTimeFormated_Err:
    Call LogError("ModLadder.GetTimeFormated - " + Erl)
End Function
...
Public Sub GetHoraActual()
    ...
    Exit Sub
GetHoraActual_Err:
    Call LogError("ModLadder.GetHoraActual en " & Erl & ". err: " & Err.Number & " " & Err.Description)
End Sub
...
Public Function SumarTiempo(segundos As Integer) As String
    ...
    Exit Function
SumarTiempo_Err:
    Call LogError("ModLadder.SumarTiempo en " & Erl & ". err: " & Err.Number & " " & Err.Description)
End Function
